...
class Product extends CoreModel {
    ...
    /**
     * Récupère la liste des tags d'un produit donné
     * 
     * @return string[]
     */
    ...
    /**
     * Méthode d'insertion d'un nouveau produit en bdd
     * 
     * @return bool
     */
    ...
    // une méthode rendue obligatoire par la classe mère abstraite ne doit pas utiliser le mot-clé "abstract"
    public function update()
    {
        ...
        // lier les valeurs au statement => utilisation de bindValue()
        // on aurait pu utiliser un array en argument d'execute()
        ...
        $statement->bindValue(':brand_id', $this->brand_id);
